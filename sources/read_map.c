...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/24 14:09:57 by joakoeni          #+#    #+#             */
/*   Updated: 2023/05/24 14:10:13 by joakoeni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

//"fdf.h" for t_coord_val type, terminate(), ft_isnumber(), ft_atoi_base(), t_map type and push()
//"libft.h" for size_t type ("libft.h" includes <string.h>), ft_memalloc(), ft_split(), ft_atoi(), NULL macros ("libft.h" includes <string.h>) and ft_strdel()
...
//Get coordinate values from line, create t_coord_val elements and them add to stack
