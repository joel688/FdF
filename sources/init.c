...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/05/24 14:09:43 by joakoeni          #+#    #+#             */
/*   Updated: 2023/05/24 14:10:13 by joakoeni         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

//"fdf.h" for t_map type, terminate(), t_fdf type, WIDTH macros, HEIGHT macros, MENU_WIDTH macros and t_camera type
//"libft.h" for ft_memalloc(), NULL macros ("libft.h" includes <string.h>),
//FT_INT_MAX macros, FT_INT_MIN macros and FT_MIN macros
//"mlx.h" for mlx_init(), mlx_new_window(), mlx_new_image() and mlx_get_data_addr()
//"error_message.h" for ERR_MAP_INIT macros, ERR_FDF_INIT macros and ERR_CAMERA_INIT macros
